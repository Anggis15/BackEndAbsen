...
import com.absenFinal.absen.config.JwtConfig;
...
public class JwtUtility implements Serializable {
    ...
    public Map<String,Object> mappingBodyToken(String token,
        ...
        mapz.put("employeeId", claims.get("employeeId"));
...
//    //    employeeId dari token
//    public Long getEmployeeIdFromToken(String token) {
//        return getClaimFromToken(token, Claims::get("employeeId"));
//    }
//
//    username dari token
